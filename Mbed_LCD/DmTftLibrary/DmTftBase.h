...
public:
  ...
  void drawXAxis(uint16_t x0, uint16_t y0, uint16_t color);
  void drawYAxis(uint16_t x0, uint16_t y0, uint16_t color);
  void drawWave(uint16_t x0, uint16_t y0, uint16_t color, double adj);
